...
def trans(file_path, drawing_id, data1):
    ...
    if(drawing_id * 100 + 1 in coordinatesBottom_data):#底面是仰视图
        ...
        ganjian.append({
            "ganjian_id": f"{member_id_base + (len(real_101) - 1) * 2 + 2}",
        ...
        ganjian.append(new_ganjian)
        new_ganjian = {
            "ganjian_id": f"{drawing_id * 100 + l1}",
            "node1_id": f"{node1_id + 20}",
        ...
        ganjian.append({
            "ganjian_id": f"{member_id_base + (len(real_102) - 1) * 2 + 2}",
            "node1_id": f"{node1_id + 20}",
        ...
        ganjian.append({
            "ganjian_id": f"{member_id_base + (len(real_103) - 1) * 2 + 2}",
            "node1_id": f"{node1_id + 20}",
